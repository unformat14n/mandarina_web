...
const taskDueSoon = [
  { Date: "Apr 2", title: "Discrete exam", status: "Completed", priority: "Low" },
  { Date: "Apr 2", title: "Discrete exam", status: "Completed", priority: "high" },
  { Date: "Apr 2", title: "Discrete exam", status: "Completed", priority: "Medium" },
  { Date: "Apr 2", title: "Discrete exam, quiz, test, exam, quiz", status: "Completed", priority: "high" },
  { Date: "Apr 2", title: "Discrete exam", status: "Completed", priority: "high" },
  { Date: "Apr 2", title: "Discrete exam", status: "Completed", priority: "high" },
];
    ...
    <div className="list-duesoon">
      ...
      {taskDueSoon.map((task, index) => (
        <div key={index} className="task-item">
          ...
          <p className={`task-priority ${task.priority.toLowerCase()}`}>
            {task.priority}
          </p>
        </div>
      ))}
